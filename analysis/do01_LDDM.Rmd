...
# P3
## Flanker score
summary(lm(PZ_P3_onset ~ a_S1_B11 + flanker_score_d1, LDDM_do2_d1))
...
# P3
## Flanker score
summary(lm(Congruent_PZ_fpl ~ a_S2_B11 + flanker_score_d2, LDDM_do2_d2))
summary(lm(Incongruent_PZ_fpl ~ a_S2_B11 + flanker_score_d2, LDDM_do2_d2))
...
spearman_brown_d1 <- data.frame(trials=seq(15,165,15),
                             r=rep("",length(seq(15,165,15))),
                             r_ci_lower=rep("",length(seq(15,165,15))),
                             r_ci_upper=rep("",length(seq(15,165,15))))
i=1
