...
write.csv(ERN_table_d1, here("./analysis/sttr_ERN_table_d1.csv"))
...
write.csv(t(ERN_table_d1_alt1), here("./analysis/ERN_table_d1_alt1.csv"))
write.csv(t(ERN_table_d1_alt2), here("./analysis/ERN_table_d1_alt2.csv"))
write.csv(t(ERN_table_d1_alt3), here("./analysis/ERN_table_d1_alt3.csv"))
write.csv(t(ERN_table_d1_alt4), here("./analysis/ERN_table_d1_alt4.csv"))
```

##### P3
```{r}
P3_table_d1_alt1 <- data.frame(parameters= c("v", "a", "t"),
                        r= c(corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avt_v_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avt_a_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avt_t_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avt_v_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avt_a_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avt_t_z)$p)); P3_table_d1_alt1$p_corrected <- p.adjust(P3_table_d1_alt1$p_nominal, method="fdr"); P3_table_d1_alt1[,2:4] <- round(P3_table_d1_alt1[,2:4], 3)

P3_table_d1_alt2 <- data.frame(parameters= c("v", "a", "t", "z"),
                        r= c(corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_v_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_a_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_t_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_z_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_v_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_a_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_t_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_z_z)$p)); P3_table_d1_alt2$p_corrected <- p.adjust(P3_table_d1_alt2$p_nominal, method="fdr"); P3_table_d1_alt2[,2:4] <- round(P3_table_d1_alt2[,2:4], 3)

P3_table_d1_alt3 <- data.frame(parameters= c("v_congruent", "v_incongruent", "a", "t_congruent","t_incongruent", "z"),
                        r= c(corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_v_con_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_v_incon_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_a_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_t_con_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_t_incon_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_z_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_v_con_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_v_incon_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_a_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_t_con_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_t_incon_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vt_z_z)$p)); P3_table_d1_alt3$p_corrected <- p.adjust(P3_table_d1_alt3$p_nominal, method="fdr"); P3_table_d1_alt3[,2:4] <- round(P3_table_d1_alt3[,2:4], 3)

P3_table_d1_alt4 <- data.frame(parameters= c("v_congruent", "v_incongruent", "a", "t_congruent","t_incongruent", "z_congruent", "z_incongruent"),
                        r= c(corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_v_con_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_v_incon_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_a_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_t_con_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_t_incon_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_z_con_z)$r,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_z_incon_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_v_con_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_v_incon_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_a_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_t_con_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_t_incon_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_z_con_z)$p,
                             corr.test(LDDM_do2_alt_d1$PZ_P3_onset_z, LDDM_do2_alt_d1$B11_avtz_DO_vtz_z_incon_z)$p)); P3_table_d1_alt4$p_corrected <- p.adjust(P3_table_d1_alt4$p_nominal, method="fdr"); P3_table_d1_alt4[,2:4] <- round(P3_table_d1_alt4[,2:4], 3)

write.csv(t(P3_table_d1_alt1), here("./analysis/P3_table_d1_alt1.csv"))
write.csv(t(P3_table_d1_alt2), here("./analysis/P3_table_d1_alt2.csv"))
write.csv(t(P3_table_d1_alt3), here("./analysis/P3_table_d1_alt3.csv"))
write.csv(t(P3_table_d1_alt4), here("./analysis/P3_table_d1_alt4.csv"))
```
...
write.csv(ERN_table_d2, here("./analysis/sttr_ERN_table_d2.csv"))
...
write.csv(ERN_table_d3, here("./analysis/sttr_ERN_table_d3.csv"))
...
P3_table_d1 <- data.frame(parameters= c(rep(c("v", "v_congruent", "v_incongruent", "a", "t", "z"),1)),
                        r= c(corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$v_S1_B11_z)$r,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$v_congruent_S1_B11_z)$r,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$v_incongruent_S1_B11_z)$r,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$a_S1_B11_z)$r,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$t_S1_B11_z)$r,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$z_S1_B11_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$v_S1_B11_z)$p,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$v_congruent_S1_B11_z)$p,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$v_incongruent_S1_B11_z)$p,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$a_S1_B11_z)$p,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$t_S1_B11_z)$p,
                             corr.test(LDDM_do2_d1$PZ_P3_onset_z, LDDM_do2_d1$z_S1_B11_z)$p)); P3_table_d1$p_corrected <- p.adjust(P3_table_d1$p_nominal, method="fdr"); P3_table_d1[,2:4] <- round(P3_table_d1[,2:4], 3)
P3_table_d1

write.csv(P3_table_d1, here("./analysis/sttr_P3_table_d1.csv"))

ggplot(LDDM_do2_d1, aes(x=PZ_P3_onset_z, y=v_congruent_S1_B11)) +
  geom_point() +
  stat_smooth(method="lm")
```
...
P3_table_d2 <- data.frame(parameters= c(rep(c("v", "v_congruent", "v_incongruent", "a", "t", "z"),1)),
                        r= c(corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$v_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$v_congruent_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$v_incongruent_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$a_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$t_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$z_S2_B11_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$v_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$v_congruent_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$v_incongruent_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$a_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$t_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2$PZ_P3_onset_z, LDDM_do2_d2$z_S2_B11_z)$p)); P3_table_d2$p_corrected <- p.adjust(P3_table_d2$p_nominal, method="fdr"); P3_table_d2[,2:4] <- round(P3_table_d2[,2:4], 3)
P3_table_d2

write.csv(P3_table_d2, here("./analysis/sttr_P3_table_d2.csv"))

ggplot(LDDM_do2_d2, aes(x=PZ_P3_onset_z, y=v_congruent_S2_B11)) +
  geom_point() +
  stat_smooth(method="lm")
```
...
P3_table_d3 <- data.frame(parameters= c(rep(c("v", "v_congruent", "v_incongruent", "a", "t", "z"),1)),
                        r= c(corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$v_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$v_congruent_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$v_incongruent_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$a_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$t_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$z_S3_B11_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$v_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$v_congruent_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$v_incongruent_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$a_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$t_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3$PZ_P3_onset_z, LDDM_do2_d3$z_S3_B11_z)$p)); P3_table_d3$p_corrected <- p.adjust(P3_table_d3$p_nominal, method="fdr"); P3_table_d3[,2:4] <- round(P3_table_d3[,2:4], 3)
P3_table_d3

write.csv(P3_table_d3, here("./analysis/sttr_P3_table_d3.csv"))

ggplot(LDDM_do2_d3, aes(x=PZ_P3_onset_z, y=v_S3_B11)) +
  geom_point() +
  stat_smooth(method="lm")
```
...
write.csv(mr_ERN_table_d1, here("./analysis/mr_ERN_table_d1.csv"))
...
mr_P3_table_d1 <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ a_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ t_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ z_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2]),
                      p_ddm=c(tidy(lm(PZ_P3_onset_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ a_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ t_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ z_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2]),
                      b_flanker=c(tidy(lm(PZ_P3_onset_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ a_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ t_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ z_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3]),
                      p_flanker=c(tidy(lm(PZ_P3_onset_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ a_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ t_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ z_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3]))
write.csv(mr_P3_table_d1, here("./analysis/mr_P3_table_d1.csv"))

corr.test(LDDM_do2_d1$flanker_score_d1, LDDM_do2_d1$PZ_P3_onset_z, use="complete.obs", method="pearson")
```
...
write.csv(mr_ERN_table_d2, here("./analysis/mr_ERN_table_d2.csv"))
...
mr_P3_table_d2 <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ a_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ t_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ z_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2]),
                      p_ddm=c(tidy(lm(PZ_P3_onset_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ a_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ t_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ z_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2]),
                      b_flanker=c(tidy(lm(PZ_P3_onset_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ a_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ t_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ z_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3]),
                      p_flanker=c(tidy(lm(PZ_P3_onset_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ a_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ t_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ z_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3]))
write.csv(mr_P3_table_d2, here("./analysis/mr_P3_table_d2.csv"))

corr.test(LDDM_do2_d2$flanker_score_d2, LDDM_do2_d2$PZ_P3_onset_z, use="complete.obs", method="pearson")
```
...
write.csv(mr_ERN_table_d3, here("./analysis/mr_ERN_table_d3.csv"))
...
mr_P3_table_d3 <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ a_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ t_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_z ~ z_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2]),
                      p_ddm=c(tidy(lm(PZ_P3_onset_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ a_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ t_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(PZ_P3_onset_z ~ z_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2]),
                      b_flanker=c(tidy(lm(PZ_P3_onset_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ a_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ t_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_z ~ z_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3]),
                      p_flanker=c(tidy(lm(PZ_P3_onset_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ v_incongruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ a_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ t_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_z ~ z_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3]))
write.csv(mr_P3_table_d3, here("./analysis/mr_P3_table_d3.csv"))

corr.test(LDDM_do2_d3$flanker_score_d3, LDDM_do2_d3$PZ_P3_onset_z, use="complete.obs", method="pearson")
```
...
library("irr")
icc(LDDM_do2_irr[c("v_S1_B11","v_S2_B11")])
icc(LDDM_do2_irr[c("v_congruent_S1_B11.x","v_congruent_S2_B11.x")])
icc(LDDM_do2_irr[c("v_incongruent_S1_B11.x","v_incongruent_S2_B11.x")])
icc(LDDM_do2_irr[c("a_S1_B11.x","a_S2_B11.x")])
icc(LDDM_do2_irr[c("t_S1_B11.x","t_S2_B11.x")])
icc(LDDM_do2_irr[c("z_S1_B11.x","z_S2_B11.x")])

icc(LDDM_do2_irr[c("v_S2_B11","v_S3_B11")])
icc(LDDM_do2_irr[c("v_congruent_S2_B11.x","v_congruent_S3_B11.x")])
icc(LDDM_do2_irr[c("v_incongruent_S2_B11.x","v_incongruent_S3_B11.x")])
icc(LDDM_do2_irr[c("a_S2_B11.x","a_S3_B11.x")])
icc(LDDM_do2_irr[c("t_S2_B11.x","t_S3_B11.x")])
icc(LDDM_do2_irr[c("z_S2_B11.x","z_S3_B11.x")])

icc(LDDM_do2_irr[c("v_S1_B11","v_S3_B11")])
icc(LDDM_do2_irr[c("v_congruent_S1_B11.x","v_congruent_S3_B11.x")])
icc(LDDM_do2_irr[c("v_incongruent_S1_B11.x","v_incongruent_S3_B11.x")])
icc(LDDM_do2_irr[c("a_S1_B11.x","a_S3_B11.x")])
icc(LDDM_do2_irr[c("t_S1_B11.x","t_S3_B11.x")])
icc(LDDM_do2_irr[c("z_S1_B11.x","z_S3_B11.x")])
```
...
LDDM_cleaning04_fullbeh_d3 <- read.csv(here("../DDM_Trialwise_Prepped/Old/StTr_S3_ERN_HDDM_data_acc_coded.csv"))
...
# 6. Using only 8 blocks
## 6.1 ERN mean amplitude
### Day 1
```{r}
LDDM_do1_d1$v_S1_B8 <- rowMeans(LDDM_do1_d1[,c('v_congruent_S1_B8','v_incongruent_S1_B8')], na.rm=F)
LDDM_do1_d2$v_S2_B8 <- rowMeans(LDDM_do1_d2[,c('v_congruent_S2_B8','v_incongruent_S2_B8')], na.rm=F)

ERN_table_B8_d1 <- data.frame(parameters= c("z", "v_congruent", "v_incongruent", "v", "a", "t"),
                        r= c(corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$z_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$v_congruent_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$v_incongruent_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$v_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$a_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$t_S1_B8_z)$r),
                        p_nominal = c(corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$z_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$v_congruent_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$v_incongruent_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$v_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$a_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$FCZ_ERN_080_z, LDDM_do1_d1$t_S1_B8_z)$p)); ERN_table_B8_d1$p_corrected <- p.adjust(ERN_table_B8_d1$p_nominal, method="fdr"); ERN_table_B8_d1[,2:4] <- round(ERN_table_B8_d1[,2:4], 3)
ERN_table_B8_d1

ggplot(LDDM_do1_d1, aes(x=FCZ_ERN_080_z, y=v_S1_B8)) +
  geom_point() +
  stat_smooth(method="lm")
```
...
### Day 2
```{r}
ERN_table_B8_d2 <- data.frame(parameters= c("z", "v_congruent", "v_incongruent", "v", "a", "t"),
                        r= c(corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$z_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$v_congruent_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$v_incongruent_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$v_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$a_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$t_S2_B8_z)$r),
                        p_nominal = c(corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$z_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$v_congruent_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$v_incongruent_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$v_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$a_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$FCZ_ERN_080_z, LDDM_do1_d2$t_S2_B8_z)$p)); ERN_table_B8_d2$p_corrected <- p.adjust(ERN_table_B8_d2$p_nominal, method="fdr"); ERN_table_B8_d2[,2:4] <- round(ERN_table_B8_d2[,2:4], 3)
ERN_table_B8_d2

ggplot(LDDM_do1_d2, aes(x=FCZ_ERN_080_z, y=v_congruent_S2_B8)) +
  geom_point() +
  stat_smooth(method="lm")

ggplot(LDDM_do1_d2, aes(x=FCZ_ERN_080_z, y=v_S2_B8)) +
  geom_point() +
  stat_smooth(method="lm")
```
...
### Day 1
```{r}
P3_table_B8_d1 <- data.frame(parameters= c(rep(c("z", "v_congruent", "v_incongruent", "v", "a", "t"),1)),
                        r= c(corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$z_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$v_congruent_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$v_incongruent_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$v_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$a_S1_B8_z)$r,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$t_S1_B8_z)$r),
                        p_nominal = c(corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$z_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$v_congruent_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$v_incongruent_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$v_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$a_S1_B8_z)$p,
                             corr.test(LDDM_do1_d1$PZ_P3_onset_z, LDDM_do1_d1$t_S1_B8_z)$p)); P3_table_B8_d1$p_corrected <- p.adjust(P3_table_B8_d1$p_nominal, method="fdr"); P3_table_B8_d1[,2:4] <- round(P3_table_B8_d1[,2:4], 3)
P3_table_B8_d1

# ggplot(LDDM_do1_d1, aes(x=PZ_P3_onset_z, y=v_congruent_S1_B8)) +
#   geom_point() +
#   stat_smooth(method="lm")
```
...
### Day 2
```{r}
P3_table_B8_d2 <- data.frame(parameters= c(rep(c("z", "v_congruent", "v_incongruent", "v", "a", "t"),1)),
                        r= c(corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$z_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$v_congruent_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$v_incongruent_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$v_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$a_S2_B8_z)$r,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$t_S2_B8_z)$r),
                        p_nominal = c(corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$z_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$v_congruent_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$v_incongruent_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$v_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$a_S2_B8_z)$p,
                             corr.test(LDDM_do1_d2$PZ_P3_onset_z, LDDM_do1_d2$t_S2_B8_z)$p)); P3_table_B8_d2$p_corrected <- p.adjust(P3_table_B8_d2$p_nominal, method="fdr"); P3_table_B8_d2[,2:4] <- round(P3_table_B8_d2[,2:4], 3)
P3_table_B8_d2

ggplot(LDDM_do1_d1, aes(x=PZ_P3_onset_z, y=v_S1_B8)) +
  geom_point() +
  stat_smooth(method="lm")
```
