...
i=1
mr_ERN_table_d1 <- as.data.frame(matrix(nrow=6, ncol=5))
...
mr_ERN_table_d1_raw <- as.data.frame(matrix(nrow=6, ncol=5))
...
```{r}
i=1
mr_ERN_table_d2 <- as.data.frame(matrix(nrow=6, ncol=5))
...
mr_ERN_table_d2_raw <- as.data.frame(matrix(nrow=6, ncol=5))
...
```{r}
i=1
mr_ERN_table_d3 <- as.data.frame(matrix(nrow=6, ncol=5))
...
mr_ERN_table_d3_raw <- as.data.frame(matrix(nrow=6, ncol=5))
...
sttr_icc_table_123 <- data.frame(parameters= c("Drift rate", "Drift rate (congruent)", "Drift rate (incongruent)", "Boundary separation", "Non-decision time", "Starting bias", "NIH Toolbox", "Raw accuracy", "Raw accuracy (incongruent)", "RT interference"),
                           ICC=c(icc(LDDM_do2_irr[c("v_S1_B11","v_S2_B11","v_S3_B11")])$value,
...
for (s in seq(15,165,15)){
  eval(parse(text=paste0('spearman_brown_d1[i,2] <- round(as.numeric(r_sb_',s,'),3)
                         ...
                         spearman_brown_d1[i,8] <- round(as.numeric(rrt_sb_',s,'),3)
                         spearman_brown_d1[i,9] <- round(as.numeric(rrt_sb_cilower_',s,'),3)
                         spearman_brown_d1[i,10] <- round(as.numeric(rrt_sb_ciupper_',s,'),3)')))
  i=i+1
}
...
for (s in seq(15,165,15)){
  eval(parse(text=paste0('spearman_brown_d2[i,2] <- round(as.numeric(r_sb_',s,'),3)
                         ...
                         spearman_brown_d2[i,8] <- round(as.numeric(rrt_sb_',s,'),3)
                         spearman_brown_d2[i,9] <- round(as.numeric(rrt_sb_cilower_',s,'),3)
                         spearman_brown_d2[i,10] <- round(as.numeric(rrt_sb_ciupper_',s,'),3)')))
  i=i+1
}
...
for (s in seq(15,165,15)){
  eval(parse(text=paste0('spearman_brown_d3[i,2] <- round(as.numeric(r_sb_',s,'),3)
                         ...
                         spearman_brown_d3[i,8] <- round(as.numeric(rrt_sb_',s,'),3)
                         spearman_brown_d3[i,9] <- round(as.numeric(rrt_sb_cilower_',s,'),3)
                         spearman_brown_d3[i,10] <- round(as.numeric(rrt_sb_ciupper_',s,'),3)')))
  i=i+1
}
...
save(LDDM_do2_d1, LDDM_do2_d2, LDDM_do2_d3, file=here("work/data/LDDM_do2_d.RData"))
