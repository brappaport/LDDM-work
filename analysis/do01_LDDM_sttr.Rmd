...
ERN_table_d2 <- data.frame(parameters= c("v", "v_congruent", "v_incongruent", "a", "t", "z"),
                        r= c(corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$v_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$v_congruent_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$v_incongruent_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$a_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$t_S2_B11_z)$r,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$z_S2_B11_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$v_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$v_congruent_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$v_incongruent_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$a_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$t_S2_B11_z)$p,
                             corr.test(LDDM_do2_d2_not_outliers$FCZ_ERN_080_z, LDDM_do2_d2_not_outliers$z_S2_B11_z)$p)); ERN_table_d2$p_corrected <- p.adjust(ERN_table_d2$p_nominal, method="fdr"); ERN_table_d2[,2:4] <- round(ERN_table_d2[,2:4], 3)
ERN_table_d2
...
ERN_table_d3 <- data.frame(parameters= c("v", "v_congruent", "v_incongruent", "a", "t", "z"),
                        r= c(corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$v_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$v_congruent_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$v_incongruent_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$a_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$t_S3_B11_z)$r,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$z_S3_B11_z)$r),
                        p_nominal = c(corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$v_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$v_congruent_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$v_incongruent_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$a_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$t_S3_B11_z)$p,
                             corr.test(LDDM_do2_d3_not_outliers$FCZ_ERN_080_z, LDDM_do2_d3_not_outliers$z_S3_B11_z)$p)); ERN_table_d3$p_corrected <- p.adjust(ERN_table_d3$p_nominal, method="fdr"); ERN_table_d3[,2:4] <- round(ERN_table_d3[,2:4], 3)
ERN_table_d3
...
mr_P3_table_d1 <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                      ...
                      p_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                      ...
                      b_flanker=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                      ...
                      p_flanker=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
...
corr.test(LDDM_do2_d1$accuracy_z, LDDM_do2_d1$PZ_P3_onset_incon_z, use="complete.obs", method="pearson")
```
...
mr_P3_table_d2 <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                      ...
                      p_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                      ...
                      b_flanker=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
...
corr.test(LDDM_do2_d2$accuracy_z, LDDM_do2_d2$PZ_P3_onset_incon_z, use="complete.obs", method="pearson")
```
...
mr_P3_table_d3 <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                      ...
                      p_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                      ...
                      b_flanker=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
...
corr.test(LDDM_do2_d3$accuracy_z, LDDM_do2_d3$PZ_P3_onset_incon_z, use="complete.obs", method="pearson")
```
...
LDDM_do2 <- full_join(LDDM_do2_d1, LDDM_do2_d2, by="ID") %>%
  full_join(LDDM_do2_d3, by="ID")

# Days 1 to 2
icc(LDDM_do2[c("accuracy_d1","accuracy_d2")])
# Days 2 to 3
icc(LDDM_do2[c("accuracy_d2","accuracy_d3")])
# All three days
icc(LDDM_do2[c("accuracy_d1","accuracy_d2","accuracy_d3")])
```

# 5. Group level accuracy from first to second half of task
```{r}
...
```{r}
corr.test(LDDM_do2_d1$FCZ_ERN_080_z, LDDM_do2_d1$accuracy_z)
corr.test(LDDM_do2_d2$FCZ_ERN_080_z, LDDM_do2_d2$accuracy_z)
corr.test(LDDM_do2_d3$FCZ_ERN_080_z, LDDM_do2_d3$accuracy_z)
```

## 6.3 Multiple regressions
## Day 1
```{r}
mr_ERN_table_d1_acc <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(FCZ_ERN_080_z ~ v_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ a_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ t_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ z_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[2]),
                      p_ddm=c(tidy(lm(FCZ_ERN_080_z ~ v_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ a_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ t_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ z_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[2]),
                      b_acc=c(tidy(lm(FCZ_ERN_080_z ~ v_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ a_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ t_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ z_S1_B11_z + accuracy_z, LDDM_do2_d1))$estimate[3]),
                      p_acc=c(tidy(lm(FCZ_ERN_080_z ~ v_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ a_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ t_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ z_S1_B11_z + accuracy_z, LDDM_do2_d1))$p.value[3]))
write.csv(mr_ERN_table_d1_acc, here("./tables/mr_ERN_table_d1_acc.csv"))

mr_P3_table_d1_acc <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[2],
                      ...
                      p_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                       ...
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[2]),
                      b_acc=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$estimate[3]),
                      p_acc=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S1_B11_z + flanker_score_d1_z, LDDM_do2_d1))$p.value[3]))
write.csv(mr_P3_table_d1_acc, here("./tables/mr_P3_table_d1_acc.csv"))
```

## Day 2
```{r}
mr_ERN_table_d2_acc <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(FCZ_ERN_080_z ~ v_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ a_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ t_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ z_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[2]),
                      p_ddm=c(tidy(lm(FCZ_ERN_080_z ~ v_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ a_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ t_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ z_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[2]),
                      b_acc=c(tidy(lm(FCZ_ERN_080_z ~ v_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ a_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ t_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ z_S2_B11_z + accuracy_z, LDDM_do2_d2))$estimate[3]),
                      p_acc=c(tidy(lm(FCZ_ERN_080_z ~ v_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ a_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ t_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ z_S2_B11_z + accuracy_z, LDDM_do2_d2))$p.value[3]))
write.csv(mr_ERN_table_d2_acc, here("./tables/mr_ERN_table_d2_acc.csv"))

mr_P3_table_d2_acc <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[2],
                      ...
                      p_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                       ...
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[2]),
                      b_acc=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$estimate[3]),
                      p_acc=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S2_B11_z + flanker_score_d2_z, LDDM_do2_d2))$p.value[3]))
write.csv(mr_P3_table_d2_acc, here("./tables/mr_P3_table_d2_acc.csv"))
```

## Day 3
```{r}
mr_ERN_table_d3_acc <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(FCZ_ERN_080_z ~ v_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ a_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ t_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(FCZ_ERN_080_z ~ z_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[2]),
                      p_ddm=c(tidy(lm(FCZ_ERN_080_z ~ v_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ a_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ t_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(FCZ_ERN_080_z ~ z_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[2]),
                      b_acc=c(tidy(lm(FCZ_ERN_080_z ~ v_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ a_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ t_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(FCZ_ERN_080_z ~ z_S3_B11_z + accuracy_z, LDDM_do2_d3))$estimate[3]),
                      p_acc=c(tidy(lm(FCZ_ERN_080_z ~ v_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_congruent_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ v_incongruent_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ a_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ t_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(FCZ_ERN_080_z ~ z_S3_B11_z + accuracy_z, LDDM_do2_d3))$p.value[3]))
write.csv(mr_ERN_table_d3_acc, here("./tables/mr_ERN_table_d3_acc.csv"))

mr_P3_table_d3_acc <- data.frame(Parameters=c("v","v_congruent","v_incongruent","a","t","z"),
                      b_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[2],
                      ...
                      p_ddm=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                       ...
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[2]),
                      b_acc=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$estimate[3]),
                      p_acc=c(tidy(lm(PZ_P3_onset_incon_z ~ v_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_con_z ~ v_congruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ v_incongruent_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ a_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ t_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3],
                       tidy(lm(PZ_P3_onset_incon_z ~ z_S3_B11_z + flanker_score_d3_z, LDDM_do2_d3))$p.value[3]))
write.csv(mr_P3_table_d3_acc, here("./tables/mr_P3_table_d3_acc.csv"))
```

# 7. SOBP Stats
```{r}
sum(complete.cases(LDDM_do2_d1_not_outliers$v_S1_B11_z))
sum(complete.cases(LDDM_do2_d2_not_outliers$v_S2_B11_z))
sum(complete.cases(LDDM_do2_d3_not_outliers$v_S3_B11_z))

summary(lm(FCZ_ERN_080_z ~ v_S1_B11_z + flanker_score_d1_z + accuracy_z, LDDM_do2_d1_not_outliers))
summary(lm(FCZ_ERN_080_z ~ v_S2_B11_z + flanker_score_d2_z + accuracy_z, LDDM_do2_d2_not_outliers))
summary(lm(FCZ_ERN_080_z ~ v_S3_B11_z + flanker_score_d3_z + accuracy_z, LDDM_do2_d3_not_outliers))

summary(lm(FCZ_ERN_080_z ~ v_S1_B11_z, LDDM_do2_d1_not_outliers))
summary(lm(FCZ_ERN_080_z ~ v_S2_B11_z, LDDM_do2_d2_not_outliers))
summary(lm(FCZ_ERN_080_z ~ v_S3_B11_z, LDDM_do2_d3_not_outliers))
```
