...
LDDM_do2_not_outliers <- full_join(LDDM_do2_d1_not_outliers, LDDM_do2_d2_not_outliers, by="ID") %>%
  ...
  select(ID,contains("d1"),contains("d2"),contains("d3"))
...
```{r}
i=1
mr_ERN_table_d1 <- as.data.frame(matrix(nrow=length(var_names), ncol=5))
mr_ERN_table_d1[,1] <- var_names
mr_ERN_table_d1_raw <- as.data.frame(matrix(nrow=length(var_names), ncol=5))
mr_ERN_table_d1_raw[,1] <- var_names

for (var in paste0(map(var_abbreviations, str_subset, string = var_list) %>% reduce(union),"_d1_z")) {
...
```{r}
i=1
mr_ERN_table_d2 <- as.data.frame(matrix(nrow=length(var_names), ncol=5))
mr_ERN_table_d2[,1] <- var_names
mr_ERN_table_d2_raw <- as.data.frame(matrix(nrow=length(var_names), ncol=5))
mr_ERN_table_d2_raw[,1] <- var_names

for (var in paste0(map(var_abbreviations, str_subset, string = var_list) %>% reduce(union),"_d2_z")) {
  eval(parse(text=paste0("
...
```{r}
i=1
mr_ERN_table_d3 <- as.data.frame(matrix(nrow=length(var_names), ncol=5))
mr_ERN_table_d3[,1] <- var_names
mr_ERN_table_d3_raw <- as.data.frame(matrix(nrow=length(var_names), ncol=5))
mr_ERN_table_d3_raw[,1] <- var_names

for (var in paste0(map(var_abbreviations, str_subset, string = var_list) %>% reduce(union),"_d3_z")) {
  eval(parse(text=paste0("
...
sttr_icc_table_123 <- data.frame(
                      parameters=c(var_names, "NIH Toolbox", "Raw accuracy (incongruent)", "RT interference"),
                      ICC=c(icc(LDDM_do2_irr[c("v_congruent_d1_z","v_congruent_d2_z","v_congruent_d3_z")])$value,
                            icc(LDDM_do2_irr[c("v_incongruent_d1_z","v_incongruent_d2_z","v_incongruent_d3_z")])$value,
                            icc(LDDM_do2_irr[c("a_congruent_d1_z","a_congruent_d2_z","a_congruent_d3_z")])$value,
                            icc(LDDM_do2_irr[c("a_incongruent_d1_z","a_incongruent_d2_z","a_incongruent_d3_z")])$value,
                            icc(LDDM_do2_irr[c("t_congruent_d1_z","t_congruent_d2_z","t_congruent_d3_z")])$value,
                            icc(LDDM_do2_irr[c("t_incongruent_d1_z","t_incongruent_d2_z","t_incongruent_d3_z")])$value,
                            icc(LDDM_do2_irr[c("z_d1_z","z_d2_z","z_d3_z")])$value,
                      ...
                      p = c(icc(LDDM_do2_irr[c("v_congruent_d1_z","v_congruent_d2_z","v_congruent_d3_z")])$p,
                            icc(LDDM_do2_irr[c("v_incongruent_d1_z","v_incongruent_d2_z","v_incongruent_d3_z")])$p,
                            icc(LDDM_do2_irr[c("a_congruent_d1_z","a_congruent_d2_z","a_congruent_d3_z")])$p,
                            icc(LDDM_do2_irr[c("a_incongruent_d1_z","a_incongruent_d2_z","a_incongruent_d3_z")])$p,
                            icc(LDDM_do2_irr[c("t_congruent_d1_z","t_congruent_d2_z","t_congruent_d3_z")])$p,
                            icc(LDDM_do2_irr[c("t_incongruent_d1_z","t_incongruent_d2_z","t_incongruent_d3_z")])$p,
                            icc(LDDM_do2_irr[c("z_d1_z","z_d2_z","z_d3_z")])$p,
                            icc(LDDM_do2_irr[c("flanker_score_d1_z","flanker_score_d2_z","flanker_score_d3_z")])$p,
                            icc(LDDM_do2_irr[c("accuracy_incongruent_d1_z","accuracy_incongruent_d2_z","accuracy_incongruent_d3_z")])$p,
                            icc(LDDM_do2_irr[c("rt_interference_d1_z","rt_interference_d2_z","rt_interference_d3_z")])$p))

sttr_icc_table_123[,2:3] <- round(sttr_icc_table_123[,2:3], 3)
...
d1_ddm_splithalf <- read.csv(here("./data/S1_splithalf_avtz_DO_vta_sdvz.csv"), header=TRUE)
...
for (s in seq(15,165,15)){
  eval(parse(text=paste0('
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-20] <- round(d1_ddm_splithalf[,2],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-19] <- round(d1_ddm_splithalf[,3],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-18] <- round(d1_ddm_splithalf[,4],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-17] <- round(d1_ddm_splithalf[,5],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-16] <- round(d1_ddm_splithalf[,6],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-15] <- round(d1_ddm_splithalf[,7],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-14] <- round(d1_ddm_splithalf[,8],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-13] <- round(d1_ddm_splithalf[,9],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-12] <- round(d1_ddm_splithalf[,10],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-11] <- round(d1_ddm_splithalf[,11],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-10] <- round(d1_ddm_splithalf[,12],3)
                         spearman_brown_d1[,dim(spearman_brown_d1)[2]-9] <- round(d1_ddm_splithalf[,13],3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]-8] <- round(as.numeric(r_sb_',s,'),3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]-7] <- round(as.numeric(r_sb_cilower_',s,'),3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]-6] <- round(as.numeric(r_sb_ciupper_',s,'),3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]-5] <- round(as.numeric(racc_sb_',s,'),3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]-4] <- round(as.numeric(racc_sb_cilower_',s,'),3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]-3] <- round(as.numeric(racc_sb_ciupper_',s,'),3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]-2] <- round(as.numeric(rrt_sb_',s,'),3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]-1] <- round(as.numeric(rrt_sb_cilower_',s,'),3)
                         spearman_brown_d1[i,dim(spearman_brown_d1)[2]] <- round(as.numeric(rrt_sb_ciupper_',s,'),3)')))
  i=i+1
}
```
...
d2_ddm_splithalf <- read.csv(here("./data/S2_splithalf_avtz_DO_vta_sdvz.csv"), header=TRUE)
...
for (s in seq(15,165,15)){
  eval(parse(text=paste0('
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-20] <- round(d2_ddm_splithalf[,2],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-19] <- round(d2_ddm_splithalf[,3],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-18] <- round(d2_ddm_splithalf[,4],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-17] <- round(d2_ddm_splithalf[,5],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-16] <- round(d2_ddm_splithalf[,6],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-15] <- round(d2_ddm_splithalf[,7],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-14] <- round(d2_ddm_splithalf[,8],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-13] <- round(d2_ddm_splithalf[,9],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-12] <- round(d2_ddm_splithalf[,10],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-11] <- round(d2_ddm_splithalf[,11],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-10] <- round(d2_ddm_splithalf[,12],3)
                         spearman_brown_d2[,dim(spearman_brown_d2)[2]-9] <- round(d2_ddm_splithalf[,13],3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]-8] <- round(as.numeric(r_sb_',s,'),3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]-7] <- round(as.numeric(r_sb_cilower_',s,'),3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]-6] <- round(as.numeric(r_sb_ciupper_',s,'),3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]-5] <- round(as.numeric(racc_sb_',s,'),3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]-4] <- round(as.numeric(racc_sb_cilower_',s,'),3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]-3] <- round(as.numeric(racc_sb_ciupper_',s,'),3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]-2] <- round(as.numeric(rrt_sb_',s,'),3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]-1] <- round(as.numeric(rrt_sb_cilower_',s,'),3)
                         spearman_brown_d2[i,dim(spearman_brown_d2)[2]] <- round(as.numeric(rrt_sb_ciupper_',s,'),3)')))
  i=i+1
}
```
...
d3_ddm_splithalf <- read.csv(here("./data/S3_splithalf_avtz_DO_vta_sdvz.csv"), header=TRUE)
...
for (s in seq(15,165,15)){
  eval(parse(text=paste0('
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-20] <- round(d3_ddm_splithalf[,2],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-19] <- round(d3_ddm_splithalf[,3],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-18] <- round(d3_ddm_splithalf[,4],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-17] <- round(d3_ddm_splithalf[,5],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-16] <- round(d3_ddm_splithalf[,6],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-15] <- round(d3_ddm_splithalf[,7],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-14] <- round(d3_ddm_splithalf[,8],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-13] <- round(d3_ddm_splithalf[,9],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-12] <- round(d3_ddm_splithalf[,10],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-11] <- round(d3_ddm_splithalf[,11],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-10] <- round(d3_ddm_splithalf[,12],3)
                         spearman_brown_d3[,dim(spearman_brown_d3)[2]-9] <- round(d3_ddm_splithalf[,13],3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]-8] <- round(as.numeric(r_sb_',s,'),3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]-7] <- round(as.numeric(r_sb_cilower_',s,'),3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]-6] <- round(as.numeric(r_sb_ciupper_',s,'),3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]-5] <- round(as.numeric(racc_sb_',s,'),3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]-4] <- round(as.numeric(racc_sb_cilower_',s,'),3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]-3] <- round(as.numeric(racc_sb_ciupper_',s,'),3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]-2] <- round(as.numeric(rrt_sb_',s,'),3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]-1] <- round(as.numeric(rrt_sb_cilower_',s,'),3)
                         spearman_brown_d3[i,dim(spearman_brown_d3)[2]] <- round(as.numeric(rrt_sb_ciupper_',s,'),3)')))
  i=i+1
}
```
