...
```{r}
LDDM_do3_rdoc_no_outliers <- filter(LDDM_do3_rdoc,FCz_ERN_080>-3 & FCz_ERN_080<3)
```
...
var_list <- c("B11_avtz_DO_v_v","B11_avtz_DO_v_v_con","B11_avtz_DO_v_v_incon","B11_avtz_DO_v_a","B11_avtz_DO_v_t","B11_avtz_DO_v_z",
              ...
              "Inhib_time","Pred_FSIQ","Motor_time","Age")
...
write.csv(ERN_table, here("./analysis/rdoc_ERN_table.csv"))
...
write.csv(t(ERN_table_rdoc_alt1), here("./analysis/rdoc_ERN_table_alt1.csv"))
write.csv(t(ERN_table_rdoc_alt2), here("./analysis/rdoc_ERN_table_alt2.csv"))
write.csv(t(ERN_table_rdoc_alt3), here("./analysis/rdoc_ERN_table_alt3.csv"))
write.csv(t(ERN_table_rdoc_alt4), here("./analysis/rdoc_ERN_table_alt4.csv"))
```
...
summary(lmer(FCz_ERN_080_z ~ B11_avtz_DO_v_v_z + flanker_score_rdoc_z + (1 | F_ID), LDDM_do3_rdoc))
summary(lmer(FCz_ERN_080_z ~ B11_avtz_DO_v_v_con_z + flanker_score_rdoc_z + (1 | F_ID), LDDM_do3_rdoc))
summary(lmer(FCz_ERN_080_z ~ B11_avtz_DO_v_v_incon_z + flanker_score_rdoc_z + (1 | F_ID), LDDM_do3_rdoc))
summary(lmer(FCz_ERN_080_z ~ B11_avtz_DO_v_a_z + flanker_score_rdoc_z + (1 | F_ID), LDDM_do3_rdoc))
summary(lmer(FCz_ERN_080_z ~ B11_avtz_DO_v_t_z + flanker_score_rdoc_z + (1 | F_ID), LDDM_do3_rdoc))
summary(lmer(FCz_ERN_080_z ~ B11_avtz_DO_v_z_z + flanker_score_rdoc_z + (1 | F_ID), LDDM_do3_rdoc))

ggplot(filter(LDDM_do3_rdoc_no_outliers), aes(x=FCz_ERN_080_z, y=flanker_score_rdoc_z)) +
  geom_point() +
  stat_smooth(method="lm")

# Without subjects with <80% accuracy
summary(lm(FCz_ERN_080_z ~ B11_avtz_DO_v_v_z + flanker_score_rdoc_z,
           filter(LDDM_do3_rdoc_no_outliers, flanker_score_rdoc_z>4)))
...
## 6.2 Correlations between Inhibition time and DDM parameters
```{r}
...
write.csv(CW_table, here("./analysis/CW_table.csv"))
```

## 6.3 Inhibition time predicted by DDM and NIH Toolbox
```{r}
corr.test(LDDM_do3_rdoc$Inhib_time_z, LDDM_do3_rdoc$flanker_score_rdoc_z)

summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_con_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_incon_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_a_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_t_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_z_z + flanker_score_rdoc_z, LDDM_do3_rdoc))

summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time + Age, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_con_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time + Age, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_incon_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time + Age, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_a_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time + Age, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_t_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time + Age, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_z_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time + Age, LDDM_do3_rdoc))
