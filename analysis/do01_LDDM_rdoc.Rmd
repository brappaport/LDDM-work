...
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_con_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_v_incon_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_a_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_t_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time, LDDM_do3_rdoc))
summary(lm(Inhib_time_z ~ B11_avtz_DO_v_z_z + flanker_score_rdoc_z + Pred_FSIQ + Motor_time, LDDM_do3_rdoc))
...
LDDM_do3_rdoc_sib <- LDDM_do3_rdoc %>%
  pivot_wider(id_cols=F_ID, names_from=S_ID, 
              values_from=c(B11_avtz_DO_v_v_z, B11_avtz_DO_v_v_con_z, B11_avtz_DO_v_v_incon_z,
                            B11_avtz_DO_v_a_z,B11_avtz_DO_v_t_z,B11_avtz_DO_v_z_z,flanker_score_rdoc_z))

LDDM_heritability_table <- data.frame(parameters= c("v", "v_congruent", "v_incongruent", "a", "t", "z", "nihtoolbox_flanker"),
...
write.csv(LDDM_heritability_table, "./analysis/rdoc_heritability_table.csv")
```
