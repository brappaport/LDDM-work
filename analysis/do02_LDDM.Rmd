...
summary(lm(FCz_ERN_080_z ~ B11_avtz_DO_v_v_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(FCz_ERN_080_z ~ B11_avtz_DO_v_v_con_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(FCz_ERN_080_z ~ B11_avtz_DO_v_v_incon_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(FCz_ERN_080_z ~ B11_avtz_DO_v_a_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(FCz_ERN_080_z ~ B11_avtz_DO_v_t_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
summary(lm(FCz_ERN_080_z ~ B11_avtz_DO_v_z_z + flanker_score_rdoc_z, LDDM_do3_rdoc))
