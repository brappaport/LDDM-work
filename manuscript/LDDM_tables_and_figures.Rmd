...
#                    "DR","DR (co)","Drift rate (incon)","BS","Inhibition","EF"),1)
rownames(rdoc_correlations)=rep(c("ERN","NIH","Acc",
                   "DR","DR (con)","DR (incon)","BS","Inhibition","EF"),1)
...
apa_table(rdoc_correlations,
           ...
           col.names=c("Measures","ERN","NIH","Acc",
                   "DR","DR con","DR incon","BS","Inhibition","EF"),
           font_size="footnotesize",
           caption = "Bivariate spearman correlations among Study 1 variables",
           note = "** p < .01, * p < .05. ERN: error-related negativity, NIH: NIH Toolbox, Acc: raw accuracy (incongruent), DR: drift rate, BS: boundary separation, con: congruent trials, incon: incongruent trials, EF: executive functioning.",
           landscape=TRUE
)
...
make_splithalf_datatable <- function (df) {
  data.frame(trials=seq(15,165,15),
                             ...
                             rv_ciupper=rowMeans(df[,c("avtz_DO_v_df_v_con_ci_lower","avtz_DO_v_df_v_inc_ci_lower")]),
