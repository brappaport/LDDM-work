...
author: 
  - name          : "Brent I. Rappaport, Allison M. Letkiewicz, James E. Glazer, Savannah N. Buchanan, Anna Weinberg, Stewart A. Shankman"
...
```{r, fig.cap = "Test-retest reliability of drift rate separated by condition across three sessions.", out.width='100%'}
...
mr_ERN_table_d1_raw_new <- mr_ERN_table_d1_raw_new %>%
  ...
  mutate(measure_new = factor(measure_new, levels=c("NIH Toolbox", "Accuracy (incongruent)", "RT interference", "Drift rate","Drift rate (congruent)", "Drift rate (incongruent)", "Boundary separation")))

ern_d1 <- ggplot(mr_ERN_table_d1_raw_new[c(1:16),], aes(x=est, label=parameters, y=measure_new, color=measure_new)) +
...
ern_d2 <- ggplot(mr_ERN_table_d2_raw_new[c(1:16),], aes(x=est, label=parameters, y=measure_new, color=measure_new)) +
  geom_point(position=position_dodge(width = 1), stat = "identity") +
  geom_errorbar(aes(xmin=lci, xmax=uci), width=.1,  position=position_dodge(width = 1), stat="identity") +
  geom_vline(xintercept = 0) +
...
ern_d3 <- ggplot(mr_ERN_table_d3_raw_new[c(1:16),], aes(x=est, label=parameters, y=measure_new, color=measure_new)) +
  geom_point(position=position_dodge(width = 1), stat = "identity") +
  geom_errorbar(aes(xmin=lci, xmax=uci), width=.1,  position=position_dodge(width = 1), stat="identity") +
  geom_vline(xintercept = 0) +
...
ern_rdoc <- ggplot(mr_ERN_table_rdoc_raw_plot[c(5:12),], aes(x=est, label=parameters, y=measure_new, color=measure_new)) +
  geom_point(position=position_dodge(width = 1), stat = "identity") +
  geom_errorbar(aes(xmin=lci, xmax=uci), width=.1,  position=position_dodge(width = 1), stat="identity") +
  geom_vline(xintercept = 0) +
...
i=1
mr_ERN_table_d1_no_rt <- as.data.frame(matrix(nrow=6, ncol=5))
mr_ERN_table_d1_no_rt[,1] <- c("Drift rate","Drift rate (congruent)","Drift rate (incongruent)","Boundary separation","Non-decision time","Starting bias")
mr_ERN_table_d1_no_rt_raw <- as.data.frame(matrix(nrow=6, ncol=5))
mr_ERN_table_d1_no_rt_raw[,1] <- c("Drift rate","Drift rate (congruent)","Drift rate (incongruent)","Boundary separation","Non-decision time","Starting bias")
...
### Day 2
i=1
mr_ERN_table_d2_no_rt <- as.data.frame(matrix(nrow=6, ncol=5))
mr_ERN_table_d2_no_rt[,1] <- c("Drift rate","Drift rate (congruent)","Drift rate (incongruent)","Boundary separation","Non-decision time","Starting bias")
mr_ERN_table_d2_no_rt_raw <- as.data.frame(matrix(nrow=6, ncol=5))
mr_ERN_table_d2_no_rt_raw[,1] <- c("Drift rate","Drift rate (congruent)","Drift rate (incongruent)","Boundary separation","Non-decision time","Starting bias")
...
### Day 3
i=1
mr_ERN_table_d3_no_rt <- as.data.frame(matrix(nrow=6, ncol=5))
mr_ERN_table_d3_no_rt[,1] <- c("Drift rate","Drift rate (congruent)","Drift rate (incongruent)","Boundary separation","Non-decision time","Starting bias")
mr_ERN_table_d3_no_rt_raw <- as.data.frame(matrix(nrow=6, ncol=5))
mr_ERN_table_d3_no_rt_raw[,1] <- c("Drift rate","Drift rate (congruent)","Drift rate (incongruent)","Boundary separation","Non-decision time","Starting bias")
...
ern_d1_no_rt <- ggplot(mr_ERN_table_d1_no_rt_raw_new[c(1:12),], aes(x=est, label=parameters, y=measure_new, color=measure_new)) +
  geom_point(position=position_dodge(width = 1), stat = "identity") +
  geom_errorbar(aes(xmin=lci, xmax=uci), width=.1,  position=position_dodge(width = 1), stat="identity") +
  geom_vline(xintercept = 0) +
  labs(y="Flanker behavioral measure", x="beta [95% CI]", title="Session 1") +
...
ern_d2_no_rt <- ggplot(mr_ERN_table_d2_no_rt_raw_new[c(1:12),], aes(x=est, label=parameters, y=measure_new, color=measure_new)) +
  geom_point(position=position_dodge(width = 1), stat = "identity") +
  geom_errorbar(aes(xmin=lci, xmax=uci), width=.1,  position=position_dodge(width = 1), stat="identity") +
  geom_vline(xintercept = 0) +
  labs(y="Flanker behavioral measure", x="beta [95% CI]", title="Session 2") +
...
ern_d3_no_rt <- ggplot(mr_ERN_table_d3_no_rt_raw_new[c(1:12),], aes(x=est, label=parameters, y=measure_new, color=measure_new)) +
  geom_point(position=position_dodge(width = 1), stat = "identity") +
  geom_errorbar(aes(xmin=lci, xmax=uci), width=.1,  position=position_dodge(width = 1), stat="identity") +
  geom_vline(xintercept = 0) +
  labs(y="Flanker behavioral measure", x="beta [95% CI]", title="Session 3") +
