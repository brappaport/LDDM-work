...
sttr_icc_table$parameters <- factor(sttr_icc_table$parameters, levels = sttr_icc_table$parameters)
ggplot(sttr_icc_table, aes(x=parameters, y=ICC)) +
  geom_point() +
