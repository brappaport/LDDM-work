...
LDDM_cleaning02_DDM1 <- read.csv(here("DDM_Results/Block_Based_Day1/Flanker_StTr_S1_Blocks_acc_avtz_DO_v.csv"))
LDDM_cleaning02_DDM1$ID <- LDDM_cleaning02_DDM1$id

LDDM_cleaning02_DDM2 <- read.csv(here("DDM_Results/Block_Based_Day2/Flanker_StTr_S2_Blocks_DO_v.csv"))
LDDM_cleaning02_DDM2$ID <- LDDM_cleaning02_DDM2$id

LDDM_cleaning02_DDM3 <- read.csv(here("DDM_Results/Block_Based_Day3/Day3_Block11_Alternative_Models.csv"))
