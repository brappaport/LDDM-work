...
LDDM_cleaning04_rdoc_calc4 <- full_join(LDDM_cleaning04_rdoc_calc3, LDDM_cleaning04_rdoc_accuracy_by_condition, by="ID") %>%
  select(-subj_idx)
```
...
save(LDDM_cleaning04_rdoc_calc4, LDDM_cleaning04_rdoc_calc1, LDDM_cleaning04_rdoc_calc3_short, file=here("./data/LDDM_cleaning04_rdoc_calc4.RData"))
