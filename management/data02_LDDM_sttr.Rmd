...
```{r}
here::i_am("work/management/data02_LDDM_sttr.Rmd")
...
sttr_all_data <- read_sav("./data/STTR_master_6.6.18_clean_ERN_PE_LPPbehav.sav") %>%
  select(ID, Age)
```
...
LDDM_cleaning04_d1_calc3 <- LDDM_cleaning04_d1_calc1 %>%
  ...
  summarise(flanker_score = mean(flanker_score_list_d1),
...
LDDM_cleaning04_d1_accuracy_by_condition <- LDDM_cleaning04_d1_calc1 %>%
  ...
  mutate(total_accuracy_perc = sum(response==1)/length(response)) %>% # compute total accuracy percentage
  summarise(accuracy_by_stim = mean(total_accuracy_perc)) %>%
...
LDDM_cleaning04_d2_calc3 <- LDDM_cleaning04_d2_calc1 %>%
  ...
  group_by(ID) %>% # per subject
  summarise(flanker_score = mean(flanker_score_list_d2),
...
LDDM_cleaning04_d3_calc3 <- LDDM_cleaning04_d3_calc1 %>%
  ...
  group_by(ID) %>% # per subject
  summarise(flanker_score = mean(flanker_score_list_d3),
...
save(LDDM_cleaning04_fullbeh_d1, file=here("./work/data/LDDM_cleaning04_fullbeh_d1.RData"))
save(LDDM_cleaning04_fullbeh_d2, file=here("./work/data/LDDM_cleaning04_fullbeh_d2.RData"))
save(LDDM_cleaning04_fullbeh_d3, file=here("./work/data/LDDM_cleaning04_fullbeh_d3.RData"))

save(LDDM_cleaning04_d1_calc4, LDDM_cleaning04_d1_calc1, LDDM_cleaning04_d1_calc3_short, LDDM_cleaning04_d1_ind, file=here("./work/data/LDDM_cleaning04_d1_calc4.RData"))
save(LDDM_cleaning04_d2_calc4, LDDM_cleaning04_d2_calc1, LDDM_cleaning04_d2_calc3_short, LDDM_cleaning04_d2_ind, file=here("./work/data/LDDM_cleaning04_d2_calc4.RData"))
save(LDDM_cleaning04_d3_calc4, LDDM_cleaning04_d3_calc1, LDDM_cleaning04_d3_calc3_short, LDDM_cleaning04_d3_ind, file=here("./work/data/LDDM_cleaning04_d3_calc4.RData"))
